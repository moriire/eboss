...
<nav class="navbar navbar-expand-lg navbar-dark pb_navbar pb_scrolled-light" id="templateux-navbar">
      <div class="container">
        <a class="navbar-brand" :href="`/${$route.params.user_id}/all`"><span class="text-danger">Red</span>{{ form.user.business_name_alias || form.user.business_name }}</a>
        ...
        <div class="collapse navbar-collapse" id="templateux-navbar-nav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item" v-for="(page, index) in pagetitle" v-bind:key="index"><a class="nav-link text-capitalize" :href="`#section-${page}`">{{ page }}</a></li>
    ...
    <!-- END nav -->
      ...
      <div class="container section" id="section-team" v-if="pagetitle.includes('staff')">

      <div class="row justify-content-center text-center mb-5">
        <div class="col-md-7 mb-5">
          <h2 class="heading text-capitalize" data-aos="fade-up">{{ staffpage[0] }} <span data-toggle="modal" :data-target="`#page-title-${pageHeaders('staff').title }`"><i class="fa fa-pencil-square-o"></i></span></h2>
        </div>
      </div>

      <div class="row">
        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100" v-for="staff in form.staff" v-bind:key="staff.id">
      ...
      <section class="section testimonial-section" id="section-review" v-if="pagetitle.includes('review')">
        <div class="container">
          <div class="row justify-content-center text-center mb-5">
            <div class="col-md-7">
              <h2 class="heading text-capitalize" data-aos="fade-up">{{ reviewpage[0] }} <span data-toggle="modal" :data-target="`#page-title-${pageHeaders('review').title }`"><i class="fa fa-pencil-square-o"></i></span></h2>
            </div>
          </div>
          <div class="row jsutify-content-center align-items-center text-center" v-if="form.review.length===0">
            <div class="col-lg-12 mb-5" data-aos="fade-up" data-aos-delay="200">
              <h2 class="heading text-capitalize" data-aos="fade-up"> Add review 
                <span>

                    <i class="fa fa-plus" data-toggle="modal" :data-target="`#page-add-${pageHeaders('review').title }`" ></i>
                    </span></h2>
            </div>
          </div>
          <div class="row jsutify-content-center align-items-center text-center" v-else>
            <div class="col-lg-12 mb-5" data-aos="fade-up" data-aos-delay="200">
      ...
      <section class="section bg-image overlay" :style="`background-image: url(${pageHeaders('menu').background});`" id="section-menu" v-if="pagetitle.includes('menu')">
        <div class="container">
          <div class="row justify-content-center text-center mb-5">
            <div class="col-md-7">
              <h2 class="heading text-white text-capitalize" data-aos="fade">{{ menupage[0] }} <span data-toggle="modal" :data-target="`#page-title-${pageHeaders('menu').title }`"><i class="fa fa-pencil-square-o"></i></span></h2>
          ...
          <div class="col-md-5" data-aos="fade-up" data-aos-delay="200">
            <div class="row">
              <div class="col-md-10 ml-auto contact-info">
                <p><span class="d-block">Address: <i class="fa fa-pencil-square-o"></i></span> <span class="text-black text-capitalize" data-toggle="modal" data-target="#contact-section"> {{ form.user.address }} </span></p>
      ...
      <!-- Modal -->
      <div v-for="(page, index)  in form.page" class="modal fade " :id="`page-title-${page.title}`" tabindex="-1" role="dialog" aria-labelledby="pageTitle" aria-hidden="true" v-bind:key="index">
                      ...
                      <div class="col-md-6 form-group">
                        ...
                        <div class="field-icon-wrap">
                          ...
                          <select name="" id="title" class="form-control" v-model="page.title">
                            <option :value="sec.title" v-for="sec in form.page" v-bind:key="sec.id">{{ sec.title }}</option>
                            </select>
                        </div>
                      </div>
                      <div class="col-md-6 form-group">
      ...
      <!-- Modal -->
      <!-- Review Modal -->
      <div class="modal fade" id="about-section" tabindex="-1" role="dialog" aria-labelledby="page-add-review" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="row">
                <div class="col-md-12" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <form @submit.prevent="editAbout" class="bg-dark p-4">
                    <div class="row mb-3"><div class="col-12"><h2>Add section</h2></div></div>
                    
                    <div class="row">
                      <div class="col-md-6 form-group">
                        <label for="full_name" class="font-weight-bold text-black">Full name(You can leave blank)</label>
                        <div class="field-icon-wrap">
                          
                          <input type="text" id="full_name" v-model="review.full_name" class="form-control"/>
                        </div>
                      </div>
                      <div class="col-md-6 form-group">
                        <label for="phone" class="font-weight-bold text-black">Full name(You can leave blank)</label>
                        <div class="field-icon-wrap">
                          
                          <input type="text" id="phone" v-model="review.phone" class="form-control"/>
                        </div>
                      </div>
                    </div>
                    <div class="row mb-4">
                      <label for="phone" class="font-weight-bold text-black">Email</label>
                        <div class="field-icon-wrap">
                          
                          <input type="email" id="phone" v-model="review.email" class="form-control"/>
                        </div>
                      </div>
                    ...
                    <div class="row mb-4">
                      <div class="col-md-12 form-group">
                        ...
                        <textarea name="message" id="message" class="form-control " rows="2" v-model="review.body"></textarea>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6 form-group">
...
export default {
  ...
  computed:{
    ...
    staffpage(){
    const headers = this.pageHeaders('staff')
      return [ headers.title_alias || headers.title, headers.subtitle]
    },
  }
  }
