...
<section class="py-5 bg-light" id="section-about">
        <div class="container">
          <div class="row align-items-center">
            <div :class="about.thumb? 'col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5': 'd-none'" data-aos="fade-up">
              <img :src="image" alt="Image" class="img-fluid rounded" />
            </div>
            <div :class="about.thumb? 'col-md-12 col-lg-4 order-lg-1': 'col-lg-12'" data-aos="fade-up">
              <h3 class="heading mb-4 text-capitalize">{{ header.title }}</h3>
