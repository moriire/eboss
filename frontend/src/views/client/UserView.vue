<template>
  <form>
    ...
    <div class="row">
        ...
        <input id="first_name" type="text" class="form-control active" autocompleted="" v-model="form.first_name" readonly />
   ...
   <div class="form-outline mb-4">
        <input id="other_name" type="text" class="form-control active" autocompleted="" v-model="form.other_name" readonly />
        ...
        <div class="form-outline mb-4">
        <select id="gender" class="form-control active" v-model="form.gender" readonly>
   ...
   <div class="form-outline mb-4">
        <select id="grade" class="form-control active" v-model="form.grade" readonly>
